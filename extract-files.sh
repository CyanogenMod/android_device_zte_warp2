...
adb pull /system/bin/akmd8962_new ../../../vendor/zte/$DEVICE/proprietary/akmd8962_new
chmod 755 ../../../vendor/zte/$DEVICE/proprietary/akmd8962_new
...
adb pull /system/lib/libOmxAmrDec.so ../../../vendor/zte/$DEVICE/proprietary/libOmxAmrDec.so
adb pull /system/lib/libOmxAmrEnc.so ../../../vendor/zte/$DEVICE/proprietary/libOmxAmrEnc.so
adb pull /system/lib/libstagefright_avc_common.so ../../../vendor/zte/$DEVICE/proprietary/libstagefright_avc_common.so
adb pull /system/lib/libstagefright_soft_mpeg4dec.so ../../../vendor/zte/$DEVICE/proprietary/libstagefright_soft_mpeg4dec.so
adb pull /system/lib/libOmxMp3Dec.so ../../../vendor/zte/$DEVICE/proprietary/libOmxMp3Dec.so
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/zte/__DEVICE__/proprietary/akmd8962_new:system/bin/akmd8962_new \\
    ...
    vendor/zte/__DEVICE__/proprietary/libOmxAmrDec.so:system/lib/libOmxAmrDec.so \\
    vendor/zte/__DEVICE__/proprietary/libOmxAmrEnc.so:system/lib/libOmxAmrEnc.so \\
    vendor/zte/__DEVICE__/proprietary/libstagefright_avc_common.so:system/lib/libstagefright_avc_common.so \\
    vendor/zte/__DEVICE__/proprietary/libstagefright_soft_mpeg4dec.so:system/lib/libstagefright_soft_mpeg4dec.so \\
    vendor/zte/__DEVICE__/proprietary/libOmxMp3Dec.so:system/lib/libOmxMp3Dec.so \\
